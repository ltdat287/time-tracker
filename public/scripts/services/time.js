    ...
    angular
        ...
        function time($resource) {
            ...
            function getTime() {
                ...
                return Time.query().$promise.then(function(results) {
                    angular.forEach(results, function(result) {
                        // Add the loggedTime property which calls getTimeDiff to give us a duration object
            ...
            function getTotalTime(timeentries) {
                ...
                // After 24 hours, the Moment.js duration object reports the next unit up, which is days.
                // Using the asHours method and rounding down with Math.floor instead us the toal hours
                return {
